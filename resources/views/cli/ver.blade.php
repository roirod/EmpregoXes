	  ...
	  <div class="input-group pad4">
		   ...
		   <div class="col-sm-3">
		    <span class="input-group-btn">
		    	<a href="{!!url("/Clientes/create")!!}" role="button" class="btn btn-sm btn-primary"> <i class="fa fa-plus"></i> Nuevo</a>
		    </span> 
		   </div>
	  </div>
 </div>
			   ...
			   <div class="box400">
				   <table class="table table-hover">
						...
						@foreach ($clientes as $cliente)
							...
							<tr>
								<td class="wid50">
									<a class="btn btn-default" href="{!!url("/Clientes/$cliente->idcli")!!}" target="_blank" role="button"><i class="fa fa-hand-pointer-o"></i> </a> 
								</td>
